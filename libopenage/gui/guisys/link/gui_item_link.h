...
/**
 * If the core 'MyClass' has a shell 'MyClassLink' then 'Wrap<MyClass>' must have a 'typedef MyClassLink Type'
 */
template<typename U>
struct Wrap {
};
...
/**
 * If the core 'MyClass' has a shell 'MyClassLink' then 'Unwrap<MyClassLink>' must have a 'typedef MyClass Type'
 */
template<typename T>
struct Unwrap {
};
