...
namespace {
const int registration = qmlRegisterUncreatableType<GuiLiveReloaderAttachedPropertyProvider>("com.openage", 1, 0, "LR", "LR is non-instantiable. It provides the 'LR.tag' attached property.");
