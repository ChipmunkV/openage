...
private:
	typedef std::unordered_map<QString, std::unique_ptr<PersistentCoreHolderBase>> TagToPreservableMap;
	TagToPreservableMap preservable;
};

}} // namespace openage::gui

QML_DECLARE_TYPEINFO(openage::gui::GuiLiveReloaderAttachedPropertyProvider, QML_HAS_ATTACHED_PROPERTIES)
