 ...
 */
class GuiGameSpecImageProviderImpl : public GuiImageProviderImpl {
public:
	explicit GuiGameSpecImageProviderImpl(GuiEventQueue *render_updater);
...
private:
	...
	GuiCallback render_thread_callback;
};
