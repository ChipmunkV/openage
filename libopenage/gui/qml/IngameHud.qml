	...
	Item {
		...
		Image {
			...
			ActionsGrid {
				...
				anchors.leftMargin: parent.height * 40 / 218 + metrics.unit * 1.4
				anchors.rightMargin: parent.height * 40 / 218 + metrics.unit * 0.5
				anchors.bottomMargin: parent.height * 40 / 218 - metrics.unit * 1.4
