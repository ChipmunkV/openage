...
Item {
	...
	ColumnLayout {
		...
		Rectangle {
			...
			Layout.minimumWidth: fontMetrics.averageCharacterWidth * 10
			Layout.minimumHeight: fontMetrics.averageCharacterWidth * 10
			...
			Flickable {
				anchors.fill: parent
				anchors.margins: fontMetrics.averageCharacterWidth / 2
