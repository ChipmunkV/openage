...
GuiBasic::GuiBasic(SDL_Window *window, const std::string &source, GuiSingletonItemsInfo *singleton_items_info)
	:
	application{},
	render_updater{},
	renderer{window},
	...
	subtree{&renderer, &game_logic_updater, &engine, source},
