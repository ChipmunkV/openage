...
public:
	explicit GuiBasic(SDL_Window *window, const std::string &source, GuiSingletonItemsInfo *singleton_items_info=nullptr, const std::vector<std::string> &search_paths=std::vector<std::string>{});
	virtual ~GuiBasic();
